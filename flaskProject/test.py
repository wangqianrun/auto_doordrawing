...
class Door:
    def __init__(self,total_width,total_height,small_door_width,small_door_height,flag,bloster_type):
        ...
        print('成功')
        self.acad.app.Visible = True  # 设置 AutoCAD 为后台运行
        # 创建一个新的空白文档
        # self.acad.app.Documents.Add()
        #self.acad.app.Documents.Add()  # 添加一个新的空白文档
        ...
        self.doorsize = {
            ...
            'doorframe6_y': self.total_height - (self.small_door_height),
            'doorframe5_x': self.small_door_width - 4 + 75 + 75,
            'doorframe5_y': self.small_door_height,
            'doorframe4_x': self.small_door_width - 2 + 11 + 29.3,
            'doorframe4_y': self.total_height - (self.small_door_height),
            'doorframe3_x': self.small_door_width - 4 + 29.3 + 44 + 31,
            'doorframe3_y': self.small_door_height,
            'doorframe1_x': self.small_door_width + 26 + 64.3 + 70.3,
            'doorframe1_y': self.small_door_height + 15,
            'doorframe2_x': self.small_door_width - 6 + 64.3 + 75,
            'doorframe2_y': self.small_door_height + 15,
            'doorframe8_x': self.small_door_width - 4 + 11 + 70,
            'doorframe8_y': self.total_height - (self.small_door_height + 15),
            'doorframe7_x': self.small_door_width + 28 + 11 + 70.3,
            'doorframe7_y': self.total_height - (self.small_door_height + 15)}
    ...
    def create_rectangle(self, base_point_x, base_point_y, len_x, len_y):
        ...
        coords1 = [base_point_x - len_x/2 + 0.25, base_point_y,base_point_x, base_point_y,base_point_x, base_point_y + len_y, base_point_x - len_x/2 + 0.25, base_point_y + len_y]
        coords2 = [base_point_x - len_x/2 - 0.25, base_point_y, base_point_x - len_x, base_point_y, base_point_x - len_x, base_point_y + len_y, base_point_x - len_x/2 - 0.25 , base_point_y + len_y]
        new_line1 = self.acad.model.AddLightWeightPolyline(array.array("d", coords1))
    ...
    def create_four_rounded_rectangle(self, base_point_x, base_point_y, len_x, len_y):
        ...
        self.create_line(base_point_x, base_point_y - 2, base_point_x + len_x/2 - 0.25, base_point_y - 2)
        self.create_line(base_point_x + len_x, base_point_y - 2, base_point_x + len_x/2 + 0.25, base_point_y - 2)
        self.create_line(base_point_x - 2, base_point_y, base_point_x - 2, base_point_y + len_y)
        self.create_line(base_point_x, base_point_y + len_y + 2, base_point_x + len_x/2 - 0.25, base_point_y + len_y + 2)
        self.create_line(base_point_x + len_x, base_point_y + len_y + 2, base_point_x + len_x / 2 + 0.25,
                         base_point_y + len_y + 2)
    ...
    def create_two_rounded_rectangle_up(self, base_point_x, base_point_y, len_x, len_y):
        ...
        self.create_line(base_point_x, base_point_y + 1, base_point_x + len_x/2 - 0.25, base_point_y + 1)
        self.create_line(base_point_x + len_x, base_point_y + 1, base_point_x + len_x / 2 + 0.25, base_point_y + 1)
        self.create_line(base_point_x - 1, base_point_y, base_point_x - 1, base_point_y - len_y)
        self.create_line(base_point_x - 1, base_point_y - len_y, base_point_x + len_x/2 - 0.25, base_point_y - len_y)
        self.create_line(base_point_x  + len_x/2 + 0.25, base_point_y - len_y, base_point_x + len_x + 1, base_point_y - len_y)
    ...
    def create_two_rounded_rectangle_down(self, base_point_x, base_point_y, len_x, len_y):
        ...
        self.create_line(base_point_x + len_x, base_point_y - 1, base_point_x + len_x / 2 + 0.25, base_point_y - 1)
        self.create_line(base_point_x - 1, base_point_y + len_y, base_point_x + len_x/2 - 0.25, base_point_y + len_y)
        self.create_line(base_point_x + len_x + 1, base_point_y + len_y, base_point_x + len_x / 2 + 0.25, base_point_y + len_y)
        self.create_line(base_point_x - 1, base_point_y, base_point_x - 1, base_point_y + len_y)
        self.create_line(base_point_x + len_x + 1, base_point_y, base_point_x + len_x + 1, base_point_y + len_y)
    ...
    def create_Door_jamb_up(self,base_point):  ## 以右下角为基点    上门边板
        ...
        len_y2 = self.small_door_height + 16
        ...
        self.create_line(coords[8], coords[9], coords[8], coords[9] - 102)
        self.create_line(coords[8] - 10, coords[9] - 100, coords[8], coords[9] - 100)
        self.create_line(base_point.x - len_x, base_point.y + 77, base_point.x - len_x, base_point.y)
        self.create_line(base_point.x - len_x, base_point.y + 75, base_point.x - len_x - 10, base_point.y + 75)
        self.create_line(base_point.x - len_x - 10, base_point.y + 75, base_point.x - len_x - 10,
                    base_point.y + len_y / 2 - 9.5 - 40.5)
        self.create_line(base_point.x - len_x - 10, base_point.y + len_y / 2 - 9.5 - 40.5, base_point.x - len_x - 10 + 9,
                    base_point.y + len_y / 2 - 9.5 - 40.5)
        self.create_line(base_point.x - len_x - 10 + 9, base_point.y + len_y / 2 - 9.5 - 40.5,
                    base_point.x - len_x - 10 + 9, base_point.y + len_y / 2 - 9.5)
        self.create_arc(base_point.x - len_x - 10 + 9 - 1, base_point.y + len_y / 2, 9.5, -84, 84)
        self.create_line(base_point.x - len_x - 10 + 9, base_point.y + len_y / 2 + 9.5 + 40.5,
                    base_point.x - len_x - 10 + 9, base_point.y + len_y / 2 + 9.5)
        self.create_line(base_point.x - len_x - 10 + 9, base_point.y + len_y / 2 + 9.5 + 40.5, base_point.x - len_x - 10,
                    base_point.y + len_y / 2 + 9.5 + 40.5)
        self.create_line(base_point.x - len_x - 10, base_point.y + len_y / 2 + 9.5 + 40.5, base_point.x - len_x - 10,
                    base_point.y + len_y - 100)
    ...
    def create_Door_jamb_down(self,base_point):  ##右下为基点   下门边板
        ...
        len_y2 = self.total_height - (self.total_height - (self.small_door_height - 5 + 15)) + 7  #以基点为底
        ...
        self.create_line(base_point.x - len_x + 10, base_point.y + 3 + 22, base_point.x - len_x + 10,
                    base_point.y + 3 + 22 + 52)
        self.create_line(base_point.x - len_x + 10, base_point.y + 3 + 22 + 50, base_point.x - len_x,
                    base_point.y + 3 + 22 + 50)

        self.create_line(base_point.x - len_x, base_point.y + 3 + 22 + 50, base_point.x - len_x,
                    base_point.y + len_y / 2 - 9.5 - 40.5)
        self.create_line(base_point.x - len_x + 9, base_point.y + len_y / 2 - 9.5 - 40.5, base_point.x - len_x,
                    base_point.y + len_y / 2 - 9.5 - 40.5)
        self.create_line(base_point.x - len_x + 9, base_point.y + len_y / 2 - 9.5 - 40.5, base_point.x - len_x + 9,
        ...
        self.create_line(base_point.x - len_x + 9, base_point.y + len_y / 2 + 9.5 + 40.5, base_point.x - len_x,
                    base_point.y + len_y / 2 + 9.5 + 40.5)
        self.create_line(base_point.x - len_x, base_point.y + len_y / 2 + 9.5 + 40.5, base_point.x - len_x,
                    base_point.y + len_y - 100)
        self.create_line(base_point.x - len_x, base_point.y + len_y - 100, base_point.x - len_x + 10,
                    base_point.y + len_y - 100)
        self.create_line(base_point.x - len_x + 10, base_point.y + len_y - 100 - 2, base_point.x - len_x + 10,
                    base_point.y + len_y)
        ...
        self.create_four_rounded_rectangle(base_point.x - 20 - 34.5, base_point.y + 462 + 2, 34.5, 176.5)
    ...
    def create_doorframe6(self,base_point):  ## 右下角为基点  右侧正面门头板
        ...
        len_y = self.total_height - (self.small_door_height)  # 高度
    ...
    def create_doorframe5(self,base_point):  ## 以左下角为基点   右侧正面小门板
        ...
        len_y = self.small_door_height            # 高度
        ...
        #加断点
        coords.append(base_point.x + 75 - 0.5)
        coords.append(base_point.y + len_y - 10)
        new_line = self.acad.model.AddLightWeightPolyline(array.array("d", coords))
        new_line.Color = 1
        new_line.Closed = False

        self.create_line(base_point.x + 75, base_point.y + len_y - 10, base_point.x + len_x - 85, base_point.y + len_y - 10)

        coords.clear()
        coords.append(base_point.x + len_x - 85 + 0.5)
        coords.append(base_point.y + len_y - 10)
        ...
        new_line.Color = 1
        new_line.Closed = False
        self.create_line(coords2[0],coords2[1],coords2[0],coords2[1] + 106)
        self.create_line(coords2[0], coords2[1] + 106 + 0.5, coords2[0], coords2[1] + 212 - 0.5)
        self.create_line(coords2[0], coords2[1]+212, coords2[0], coords2[5])

        coords2.clear()
        coords2.append(base_point.x + 5)
        coords2.append(base_point.y + 745 + 10 + 320)
        coords2.append(base_point.x + 5 + 42)
        coords2.append(base_point.y + 745 + 320 + 10)
        coords2.append(base_point.x + 5 + 42)
        coords2.append(base_point.y + 745 + 320 + 10 + 320)
        coords2.append(base_point.x + 5)
        coords2.append(base_point.y + 745 + 10 + 320 + 320)
        new_line = self.acad.model.AddLightWeightPolyline(array.array("d", coords2))
        new_line.Color = 1
        new_line.Closed = False
        self.create_line(coords2[0],coords2[1],coords2[0],coords2[1] + 106)
    ...
    def create_doorframe4(self,base_point):   ## 以右下角为基点   左侧正面门头板
        ...
        len_y = self.total_height - (self.small_door_height)   # 最下到最上高度
    ...
    def create_doorframe3(self,base_point):  ##右下为基点  左侧正面小门板

        len_x = self.small_door_width - 4 + 29.3 + 44 + 31   # 最左到最右宽度
        len_y = self.small_door_height                   # 最下到最上高度
        ...
        # 加断点
        coords.append(base_point.x - len_x + 44 + 41 - 0.5)
        coords.append(base_point.y + len_y - 10)
        new_line = self.acad.model.AddLightWeightPolyline(array.array("d", coords))
        new_line.Color = 1
        new_line.Closed = False

        self.create_line(base_point.x - len_x + 44 + 41,base_point.y + len_y, base_point.x - 39 - 0.5, base_point.y + len_y)

        coords.clear()
        coords.append(base_point.x - 39)
        coords.append(base_point.y + len_y)
        coords.append(base_point.x)
        coords.append(base_point.y + len_y)
        coords.append(base_point.x)
    ...
    def create_doorframe1(self,base_point):  # 以右下角为基点   左侧背面小门板
        ...
        len_x = self.small_door_width + 26 +  64.3 + 70.3 - 1  # 最左侧到最右宽度
        len_y = self.small_door_height + 15            # 最下到最上高度
        ...
        coords = []
        coords.append(base_point.x - 80 + 0.5)
        coords.append(base_point.y + len_y)
        coords.append(base_point.x)
        coords.append(base_point.y + len_y)
        coords.append(base_point.x)
        ...
        coords.append(base_point.x - len_x)
        coords.append(base_point.y + len_y)
        coords.append(base_point.x - len_x + 73 - 0.5)
        coords.append(base_point.y + len_y)
        new_line = self.acad.model.AddLightWeightPolyline(array.array("d", coords))
        new_line.Color = 1
        new_line.Closed = False
        ...
        #加断点
        self.create_line(base_point.x - len_x + 73, base_point.y + len_y, base_point.x - 80, base_point.y + len_y)

        self.create_hinge1(APoint(base_point.x - len_x - 1, base_point.y), 0)  # 23.3 274.25
        self.create_hinge2(APoint(base_point.x - len_x - 1, base_point.y + len_y), 0)  # 23.3 151.75
    ...
    def create_doorframe2(self,base_point):  # 以右下角为基点  右侧背面小门板
        ...
        len_x = self.small_door_width - 6 +  64.3 + 75 - 1  # 最左侧到最右宽度
        len_y = self.small_door_height + 15           # 最下到最上高度
        ...
        incise_line.append(base_point.x - 14.3)
        incise_line.append(base_point.y + 2)
        incise_line.append(base_point.x - 63.3)
        incise_line.append(base_point.y)
        incise_line.append(base_point.x - 63.3)
        incise_line.append(base_point.y + 2)
        ...
        coords2.append(base_point.x - 63.3 + 2 + 11)
        coords2.append(base_point.y + len_y)
        new_line2 = self.acad.model.AddLightWeightPolyline(array.array("d", coords2))
        new_line2.Color = 1
        new_line2.Closed = False

        self.create_hinge1(APoint(base_point.x + 1, base_point.y), 1)
        self.create_hinge2(APoint(base_point.x + 1, base_point.y + len_y), 1)
    ...
    def create_doorframe8(self,p0):  ## 右下角为基点  右侧背面门头板
        ...
        len_y = self.total_height - (self.small_door_height + 15)   # 最下到最上高度
        ...
        self.create_line(p0.x - len_x + 80 - 0.5, p0.y, p0.x - len_x, p0.y)
        self.create_line(p0.x - len_x + 80, p0.y, p0.x - 23 - 0.5, p0.y)
        self.create_line(p0.x - 23, p0.y, p0.x, p0.y)
    ...
    def left_1(self,base_point_x, base_point_y):  # 以最左侧最上第一个点为基点
        ...
        if (self.bloster_type == 1):  ## 如果是类型1  支撑的下侧固定长度一个为260 一个为530
            ...
            bia_x4 = 151 + ((x2 + 2 - 834.5) / 2) # 长度530的口距离下衔接右侧点的距离
        else:
            x3 = 320
            x4 = 620
            bia_x3 = 154.5
            bia_x4 = 106 + ((x2 + 2 - 834.5) / 2)
        ...
        obj.append(self.create_line(coords2[14], coords2[15] - 24.5, coords2[14] + 2, coords2[15] - 2 - 8))
        ...
        coords3.append(coords3[13] + 22.5)
        ...
        coords4.append(coords4[1] - 22.5)

        coords4.append(coords4[2] + x2 + 2 - x4 - bia_x4)
        coords4.append(coords4[3])

        coords4.append(coords4[4])
        coords4.append(coords4[5] + 15.5)

        coords4.append(coords4[6] + x4)
        coords4.append(coords4[7])

        coords4.append(coords4[8])
        coords4.append(coords4[9] - 15.5)

        coords4.append(coords4[10] + bia_x4)
        ...
        obj.append(self.create_arc(base_point_x + bia_cx, (y1 + y2) / 2, 30, -100, 100))
        start_point = obj[-1].StartPoint  # 圆弧的起点
        end_point = obj[-1].EndPoint  # 圆弧的终点
        obj.append(self.create_line(base_point_x, base_point_y, end_point[0], end_point[1]))
        obj.append(self.create_line(base_point_x, base_point_y - 74, start_point[0], start_point[1]))
    ...
    def right_1(self,base_point_x, base_point_y):  # 以最右侧最上第一个点为基点
        ...
        if (self.bloster_type == 1):  ## 如果是类型1  支撑的下侧固定长度一个为260 一个为530
            ...
            x4 = 530
            bia_x3 = 159  # 长度260的口距离下衔接左侧点的距离
            bia_x4 = (153.5 + (self.small_door_width - 5.9 - 834.1) / 2) # 长度530的口距离下衔接右侧点的距离
        else:
            x3 = 320
            x4 = 620
            bia_x3 = 154.5
            bia_x4 = (108.5 + (self.small_door_width - 5.9 - 834.1) / 2)
        ...
        incise_line.append(
            base_point_x - 2 - 2 - (self.total_width / 2 - 25 - self.small_door_width - 2 - 20.5) - 5 - (self.small_door_width + 24.5) - 2)
        incise_line.append(base_point_y)
        incise_line.append(base_point_x - 2 - 2 - (self.total_width / 2 - 25 - self.small_door_width - 2 - 20.5) - 5 - (
        ...
        coords4.append(coords4[10] - (self.small_door_width - 5.9 - x4 - bia_x4) )
        coords4.append(coords4[11])
        ...
        bia_cy = (y2 - y1) / 2
        bia_cx = 30 * math.sin(math.radians(10))
        a_arc = self.create_arc(base_point_x - bia_cx, (y1 + y2) / 2, 30, 80, 280)
        start_point = a_arc.StartPoint  # 圆弧的起点
        end_point = a_arc.EndPoint  # 圆弧的终点
        obj.append(self.create_line(base_point_x, base_point_y, start_point[0], start_point[1]))
        obj.append(self.create_line(base_point_x, base_point_y - 74, end_point[0], end_point[1]))
    ...
    def run(self):
        ...
        self.create_doorframe8(APoint(doorframe7_x + 205 + 1 + self.doorsize['doorframe8_x'],doorframe7_y))
        self.create_doorframe2(APoint(doorframe7_x + 205 + self.doorsize['doorframe2_x'] - 5,doorframe7_y - self.doorsize['doorframe2_y']))
